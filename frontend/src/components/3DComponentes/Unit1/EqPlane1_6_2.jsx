...
export default function EqPlane1_6_2({ args, id, handleDeleteGraph, canEdit }) {
    ...
    useEffect(() => {
        ...
        // create the plane paramatric equation in the form of ax + by + cz + d = 0 in a string
        // d is 0 because the plane passes through the origin
        const planeEquation = `${crossProduct.x}x + ${crossProduct.y}y + ${crossProduct.z}z + 0 = 0`;
